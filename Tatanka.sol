...
contract Tatanka is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Tatanka";
    string constant _symbol = "200";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 22000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 100;

    //max wallet holding of 7% 
    ...
    address public marketingFeeReceiver = 0x09D1B342c28e27D37aAAE0E6380a3741bE188828;
